...
class Users extends Employee_Controller {
	...
	public function del($id=0)
	{
		...
		$data['user'] = $user;
		$this->load->view('employee/users/modals/del', $data);
	}
	...
	public function edit($id = 0)
	{
		...
		//加载模板
		$this->template->employee_load('employee/users/edit', $this->data);
	}
	...
	public function create()
	{
		...
		//加载模板
		$this->template->employee_load('employee/users/create', $this->data);
	}
...
//                    'updated'	=> date('Y-m-d H:i:s'),
		...
		$data['user'] = $user;
		$this->load->view('employee/users/modals/reset_password', $data);
	}
	...
	public function integral()
	{
		...
		if(!empty($admin_id)){
			...
			$base_url = base_url('/employee/users/integral');
			if(!empty($keyword)){
				$base_url .="?keyword=".$keyword;
			}
			$config['base_url'] = $base_url;
			...
			//加载模板
			$this->template->employee_load('employee/users/integral', $this->data);
		}else{
			redirect("/employee");
		}
	...
	public function rides()
	{
		...
		if(!empty($admin_id)){
			...
			$base_url = base_url('/employee/users/rides');
			if(!empty($keyword)){
				$base_url .="?keyword=".$keyword;
			}
			$config['base_url'] = $base_url;
			...
			//加载模板
			$this->template->employee_load('employee/users/rides', $this->data);
		}else{
			redirect("/employee");
		}
	...
	public function evaluation()
	{
		...
		if(!empty($admin_id)){
			...
			$base_url = base_url('/employee/users/evaluation');
			if(!empty($keyword)){
				$base_url .="?keyword=".$keyword;
			}
			$config['base_url'] = $base_url;
			...
			//加载模板
			$this->template->employee_load('employee/users/evaluation', $this->data);
		}else{
			redirect("/employee");
		}
