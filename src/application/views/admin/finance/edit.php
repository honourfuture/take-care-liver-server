            ...
            <div class="col-xs-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title"><i class="fa fa-plus"></i> 处理举报</h3>
                    </div>
                    <div class="box-body">
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                <form action="/admin/report/edit" class="form-horizontal" id="createForm" method="post"
                                    ...
                                    <div class="form-group">
                                        <label for="last_name" class="col-sm-2 control-label">处理内容</label>
                                        <div class="col-sm-3">
                                            <input class="form-control" name="deal_remark" value="<?= $data->deal_remark; ?>"
                                                   required minlength="2" data-msg="请填写处理内容"
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-offset-2 col-sm-10">
                                            ...
                                            <a href="/admin/report" class="btn btn-default btn-flat">取消</a>
                                        </div>
                                    </div>
                                </form>
                            </div>
