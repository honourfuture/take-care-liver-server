                            ...
                            <?php foreach ($result as $value) : ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <!--<a href="/admin/user_urine/save/<?php /*echo $value['id']; */?>" class="btn btn-primary btn-sm pull-right"
                                           style="margin-right: 5px;"><i class="fa fa-edit"></i> 编辑</a>
                                         <a href="/admin/user_urine/view/<?php /*echo $value['id']; */?>"
                                           class="btn btn-success btn-sm pull-right" style="margin-right: 5px;"><i class="fa fa-eye"></i> 详情</a>-->
                                        <a href="/admin/urine_check/view/<?php echo $value['urine_check_id']; ?>"
