      ...
      <div class="col-xs-12">
        <div class="box">
          <div class="box-header">
            <h3 class="box-title"><a href="/admin/employee/edit" class="btn btn-block btn-primary btn-flat"><i
                  class="fa fa-plus"></i> 添加客服</a></h3>

            <div class="box-tools">
              <form action="/admin/employee/lists" method="get">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button data-toggle="modal" data-target="#boxModal"
                                                onclick="loadModal('/admin/employee/cancle/<?php echo $value['id']; ?>')"
