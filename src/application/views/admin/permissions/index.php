...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="/admin/permissions"><?php echo $page_title ?></a></li>
      ...
      <div class="col-xs-12">
        <div class="box">
          <div class="box-header">
            <h3 class="box-title"><a href="/admin/permissions/edit" class="btn btn-block btn-primary btn-flat"><i
          ...
          <div class="box-body table-responsive no-padding">
            <table class="table table-condensed table-hover">
              ...
              <tbody>
              <?php foreach ($permissions_list as $role) { ?>
                <tr>
                  <td><?= $role->id ?></td>
                  <td><?= $role->name ?></td>
                  <td><?= $role->url ?></td>
                  ...
                  <td>
                    <button data-toggle="modal" data-target="#boxModal"
                            onclick="loadModal('/admin/permissions/del/<?= $role->id ?>')"
                            class="btn btn-danger btn-sm pull-right"><i class="fa fa-remove"></i> 删除
                    </button>
                    <a href="/admin/permissions/edit/<?= $role->id ?>" class="btn btn-primary btn-sm pull-right"
            ...
            <div class="row">
              <div class="col-sm-5">
                <div class="dataTables_info" id="example2_info" role="status" aria-live="polite">
                  显示<?= $permissions_show_begin ?>-<?= $permissions_show_end ?>条，共<?= $permissions_total_rows ?>条
                </div>
              </div>
              <div class="col-sm-7">
