...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="/admin/urine_check/index"><?php echo $page_title ?></a></li>
      ...
      <div class="col-xs-12">
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">
                <!--<a href="/admin/urine_check/save" class="btn btn-block btn-primary btn-flat"><i
                  class="fa fa-plus"></i> 添加</a>-->
            </h3>

            <div class="box-tools">
              <form action="/admin/urine_check/index" method="get">
                                ...
                                <tr>
                                   ...
                                   <!-- <td><?php /*echo $value['details']; */?></td>-->
                                    ...
                                    <td>
                                        ...
                                        <a href="/admin/urine_check/save/<?php echo $value['id']; ?>" class="btn btn-primary btn-sm pull-right"
                                           style="margin-right: 5px;"><i class="fa fa-edit"></i> 编辑</a>
                                         <a href="/admin/urine_check/view/<?php echo $value['id']; ?>"
