...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="/admin/hospitals/finance"><?php echo $page_title ?></a></li>
  ...
  <section class="content">
    <div class="row">
      <div class="col-xs-12">
        <div class="box">
            <form action="/admin/hospitals/finance" method="get" id="form">
...
<script>
    ...
    function export1(){
        $("#form").attr("action","/admin/hospitals/export");
        $("#form").attr("method","post");
        $("#form").submit();
    }

    function query(){
        $("#form").attr("action","/admin/hospitals/finance");
